...
class GetTodayAttendanceUseCase implements Usecase<Either<Failure, DailyAttendanceEntity?>, String> {
  @override
  Future<Either<Failure, DailyAttendanceEntity?>> call({String? params}) async {
    ...
    return await sl<AttendanceRepository>().getTodayAttendance(params);
  }
}
